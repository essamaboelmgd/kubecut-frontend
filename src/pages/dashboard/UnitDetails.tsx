          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <div className="mb-2 flex items-center gap-3">
                ...
                {unit.settings_override && (
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button variant="outline" size="sm" className="h-8 gap-2 bg-yellow-500/10 text-yellow-600 border-yellow-500/20 hover:bg-yellow-500/20">
                    ...
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        <DialogTitle>إعدادات الوحدة المخصصة</DialogTitle>
                      </DialogHeader>
                      <div className="pointer-events-none opacity-90">
                        <UnitSettingsOverride
                          settings={unit.settings_override}
                          onSettingsChange={() => { }}
                        />
                      </div>
                    </DialogContent>
